...
In many agentic workflows, agents receive inputs without knowing whether those inputs are fixed constraints, contextual evidence, preferences, temporary working variables, or agent-owned analytical outputs. XYZ addresses that gap by assigning each governed input